...
const Custom404: React.FC = () => {
  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center">
      <div className="max-w-6xl mx-4 lg:mx-auto w-full grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
        ...
        <div className="space-y-8 text-center lg:text-left">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
            ...
            <button
              ...
              className="cursor-pointer inline-flex items-center justify-center gap-2 border border-gray-300 hover:border-gray-400 bg-white hover:bg-gray-50 text-gray-700 px-6 py-3 rounded-lg font-medium transition-all duration-200 group shadow-sm hover:shadow-md"
            >
              <FaArrowLeft className="size-5 group-hover:-translate-x-1 transition-transform duration-200" />
              Go Back
            </button>
          </div>
        </div>
